<template>
	<view class="uni-pagination">
		...
		<view class="pagination_input" ><input type="number" v-model="inputNumber"  @confirm="changePage" @blur="changePage"/></view>
...
<script>
	...
	export default {
		...
		methods: {
			changePage(){
				this.currentIndex = this.inputNumber
				this.change('next')
			},
			clickLeft() {
				...
				this.inputNumber = this.currentIndex
				this.change('prev')
			},
			clickRight() {
